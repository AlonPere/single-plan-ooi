import { Page, DirectNavigationOptions } from '@wix/sled-test-runner';
...
export interface IBootstrapConfig {
  ...
  cookieExperiments?: { key: string; val: string }[];
}
...
export class CommonViewerDriver {
  ...
  private getRemoteConfig(
    ...
    return sled
      ...
      .withControllerUrlOverride(
        this.widgetId,
        `${this.name}Controller.bundle.min.js`,
      )
